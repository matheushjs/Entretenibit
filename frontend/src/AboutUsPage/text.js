export default {
  Info: `Esse site foi desenvolvido com o objetivo de auxilar a população de 
  São Carlos no acesso a eventos de vários tipos, bem como contribuir com a 
  divulgação destes.

  O projeto foi desenvolvido para a disciplina SSC0130 - Engenharia de 
